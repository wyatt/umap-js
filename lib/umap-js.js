...
;// CONCATENATED MODULE: ./node_modules/ml-array-rescale/node_modules/is-any-array/lib-esm/index.js
...
function isAnyArray(value) {
    const tag = lib_esm_toString.call(value);
    return tag.endsWith('Array]') && !tag.includes('Big');
}
//# sourceMappingURL=index.js.map
;// CONCATENATED MODULE: ./node_modules/ml-array-max/node_modules/is-any-array/lib-esm/index.js
// eslint-disable-next-line @typescript-eslint/unbound-method
const is_any_array_lib_esm_toString = Object.prototype.toString;
/**
 * Checks if an object is an instance of an Array (array or typed array, except those that contain bigint values).
 *
 * @param value - Object to check.
 * @returns True if the object is an array or a typed array.
 */
function lib_esm_isAnyArray(value) {
    const tag = is_any_array_lib_esm_toString.call(value);
    return tag.endsWith('Array]') && !tag.includes('Big');
}
//# sourceMappingURL=index.js.map
...
;// CONCATENATED MODULE: ./node_modules/ml-array-min/node_modules/is-any-array/lib-esm/index.js
// eslint-disable-next-line @typescript-eslint/unbound-method
const node_modules_is_any_array_lib_esm_toString = Object.prototype.toString;
/**
 * Checks if an object is an instance of an Array (array or typed array, except those that contain bigint values).
 *
 * @param value - Object to check.
 * @returns True if the object is an array or a typed array.
 */
function is_any_array_lib_esm_isAnyArray(value) {
    const tag = node_modules_is_any_array_lib_esm_toString.call(value);
    return tag.endsWith('Array]') && !tag.includes('Big');
}
//# sourceMappingURL=index.js.map
...
function min(input) {
  ...
  if (!is_any_array_lib_esm_isAnyArray(input)) {
    throw new TypeError('input must be an array');
  }
...
;// CONCATENATED MODULE: ./node_modules/ml-matrix/matrix.mjs
...
var isAnyArray = __webpack_require__(103);
var rescale = __webpack_require__(544);
...
var SparseMatrix = (function () {
    ...
    SparseMatrix.prototype.setEntries = function (entries) {
        this.entries = new Map(entries);
    };
    SparseMatrix.prototype.serialize = function () {
        return {
            nRows: this.nRows,
            nCols: this.nCols,
    ...
    SparseMatrix.deserialize = function (serMatrix) {
        var sparseMatrix = new SparseMatrix([], [], [], [serMatrix.nRows, serMatrix.nCols]);
...
var FlatTree = (function () {
    ...
    FlatTree.prototype.serialize = function () {
        return {
    ...
    FlatTree.deserialize = function (serTree) {
        return new FlatTree(serTree.hyperplanes, serTree.offsets, serTree.children, serTree.indices);
    };
    return FlatTree;
}());
...
var tree = __importStar(__webpack_require__(450));
var utils = __importStar(__webpack_require__(185));
var ml_levenberg_marquardt_1 = __importDefault(__webpack_require__(142));
...
var UMAP = (function () {
    ...
    UMAP.prototype.setParameters = function (params) {
        ...
        this.optimizationState = OptimizationState.deserialize(params.optimizationState);
    };
    UMAP.prototype.serialize = function () {
        var _a = this, learningRate = _a.learningRate, localConnectivity = _a.localConnectivity, minDist = _a.minDist, nComponents = _a.nComponents, nEpochs = _a.nEpochs, nNeighbors = _a.nNeighbors, negativeSampleRate = _a.negativeSampleRate, repulsionStrength = _a.repulsionStrength, setOpMixRatio = _a.setOpMixRatio, spread = _a.spread, transformQueueSize = _a.transformQueueSize, targetMetric = _a.targetMetric, targetWeight = _a.targetWeight, targetNNeighbors = _a.targetNNeighbors, knnIndices = _a.knnIndices, knnDistances = _a.knnDistances, graph = _a.graph, X = _a.X, isInitialized = _a.isInitialized, rpForest = _a.rpForest, searchGraph = _a.searchGraph, Y = _a.Y, embedding = _a.embedding, optimizationState = _a.optimizationState;
        return {
            ...
            spread: spread,
            transformQueueSize: transformQueueSize,
            targetMetric: targetMetric,
            targetWeight: targetWeight,
            targetNNeighbors: targetNNeighbors,
            knnIndices: knnIndices,
            knnDistances: knnDistances,
            graph: graph.serialize(),
            X: X,
            isInitialized: isInitialized,
            rpForest: rpForest.map(function (t) { return t.serialize(); }),
    ...
    UMAP.deserialize = function (serUmap, params) {
        if (params === void 0) { params = {}; }
...
var OptimizationState = (function () {
    ...
    OptimizationState.prototype.serialize = function () {
        var _a = this, currentEpoch = _a.currentEpoch, headEmbedding = _a.headEmbedding, tailEmbedding = _a.tailEmbedding, head = _a.head, tail = _a.tail, epochsPerSample = _a.epochsPerSample, epochOfNextSample = _a.epochOfNextSample, epochOfNextNegativeSample = _a.epochOfNextNegativeSample, epochsPerNegativeSample = _a.epochsPerNegativeSample, moveOther = _a.moveOther, initialAlpha = _a.initialAlpha, alpha = _a.alpha, gamma = _a.gamma, a = _a.a, b = _a.b, dim = _a.dim, nEpochs = _a.nEpochs, nVertices = _a.nVertices;
        return {
    ...
    OptimizationState.deserialize = function (serState) {
